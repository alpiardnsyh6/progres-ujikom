            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/kamar" class="forms-sample" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="photoLama" value="{{ $kamar->photo }}">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="tipe">Tipe Kamar</label>
                            <input type="text" class="form-control @error ('tipe') is-invalid @enderror"  name="tipe" id="name" placeholder="Tipe Kamar......." value="{{ old('tipe') ?? $kamar->tipe }}">
                            @error('tipe')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error ('harga') is-invalid @enderror"  name="harga" id="name" placeholder="Harga Kamar......." value="{{ old('harga') ?? $kamar->harga }}">
                            @error('harga')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error ('detail') is-invalid @enderror"  name="detail" id="name" placeholder="Detail Kamar......." value="{{ old('detail') ?? $kamar->detail }}">
                            @error('detail')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row my-4 align-items-center">
                            <div class="col-3">
                                <img src="{{ asset('storage/kamar/' . ($kamar->photo ?? 'deluxe.jpg')) }}" alt="" class="img-thumbnail" width="120px" id="img-preview">
                            </div>
                            <div class="col-9">
